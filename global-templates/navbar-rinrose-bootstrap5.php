			...
			<div class="container-fluid" id="rinrose_header-collapsed">
				<div class="row w-100 justify-content-between">
					<div id="rinrose_header-collapsed_toggle" class="col-5 justify-content-start d-flex">
						<button id="rinrose_header-collapsed_toggle-btn" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#rinrose_header-expand" aria-controls="rinrose_header-expand" aria-expanded="false" aria-label="Toggle navigation">
